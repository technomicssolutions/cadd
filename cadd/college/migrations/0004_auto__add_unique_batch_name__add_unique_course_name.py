...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'college_batch', ['name'])

        # Adding unique constraint on 'Course', fields ['name']
        db.create_unique(u'college_course', ['name'])

    def backwards(self, orm):
        # Removing unique constraint on 'Course', fields ['name']
        db.delete_unique(u'college_course', ['name'])

        # Removing unique constraint on 'Batch', fields ['name']
        db.delete_unique(u'college_batch', ['name'])
