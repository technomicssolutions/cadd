...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FeesPaymentInstallment.paid_date'
        db.delete_column(u'fees_feespaymentinstallment', 'paid_date')

    def backwards(self, orm):
        # Deleting model 'FeesPaid'
        db.delete_table(u'fees_feespaid')

        # Adding field 'FeesPaymentInstallment.paid_date'
        db.add_column(u'fees_feespaymentinstallment', 'paid_date',
