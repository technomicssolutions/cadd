...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FeesPaymentInstallment.student'
        db.delete_column(u'fees_feespaymentinstallment', 'student_id')


        # Changing field 'FeesPaymentInstallment.installment'
        db.alter_column(u'fees_feespaymentinstallment', 'installment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admission.Installment'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'FeesPaymentInstallment.student'
        db.add_column(u'fees_feespaymentinstallment', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admission.Student'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'FeesPaymentInstallment.installment'
        db.alter_column(u'fees_feespaymentinstallment', 'installment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.Installment'], null=True))
