...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            current_follow_ups = Enquiry.objects.filter(follow_up_date__year=current_date.year, follow_up_date__month=current_date.month, follow_up_date__day=current_date.day, is_admitted=False)
