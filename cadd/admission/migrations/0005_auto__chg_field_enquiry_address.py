...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('admission_student_qualified_exam')

        # Removing M2M table for field technical_qualification on 'Student'
        db.delete_table('admission_student_technical_qualification')


        # Changing field 'Enquiry.address'
        db.alter_column(u'admission_enquiry', 'address', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):
        # Adding M2M table for field qualified_exam on 'Student'
        db.create_table(u'admission_student_qualified_exam', (
        ...
        db.create_unique(u'admission_student_qualified_exam', ['student_id', 'qualifiedexam_id'])

        # Adding M2M table for field technical_qualification on 'Student'
        db.create_table(u'admission_student_technical_qualification', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm[u'admission.student'], null=False)),
            ('technicalqualification', models.ForeignKey(orm[u'college.technicalqualification'], null=False))
        ))
        db.create_unique(u'admission_student_technical_qualification', ['student_id', 'technicalqualification_id'])


        # Changing field 'Enquiry.address'
        db.alter_column(u'admission_enquiry', 'address', self.gf('django.db.models.fields.CharField')(max_length=600, null=True))
    models = {
        u'admission.enquiry': {
