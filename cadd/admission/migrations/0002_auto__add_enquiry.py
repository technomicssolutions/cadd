...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'admission_enquiry', (
            ...
            ('address', self.gf('django.db.models.fields.CharField')(max_length=600, null=True, blank=True)),
            ...
            ('remarks_for_follow_up_date', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
    ...
    models = {
        u'admission.enquiry': {
            ...
            'remarks_for_follow_up_date': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
