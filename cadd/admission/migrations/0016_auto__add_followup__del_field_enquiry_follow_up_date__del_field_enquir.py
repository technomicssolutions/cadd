...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Enquiry.follow_up_date'
        db.delete_column(u'admission_enquiry', 'follow_up_date')

        # Deleting field 'Enquiry.remarks_for_follow_up_date'
        db.delete_column(u'admission_enquiry', 'remarks_for_follow_up_date')

    def backwards(self, orm):
        # Deleting model 'FollowUp'
        db.delete_table(u'admission_followup')

        # Adding field 'Enquiry.follow_up_date'
        db.add_column(u'admission_enquiry', 'follow_up_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Enquiry.remarks_for_follow_up_date'
        db.add_column(u'admission_enquiry', 'remarks_for_follow_up_date',
