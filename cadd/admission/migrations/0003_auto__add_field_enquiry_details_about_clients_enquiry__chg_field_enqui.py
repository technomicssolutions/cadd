...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enquiry.details_about_clients_enquiry'
        db.add_column(u'admission_enquiry', 'details_about_clients_enquiry',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Enquiry.remarks_for_follow_up_date'
        db.alter_column(u'admission_enquiry', 'remarks_for_follow_up_date', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Enquiry.remarks'
        db.alter_column(u'admission_enquiry', 'remarks', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):
        # Deleting field 'Enquiry.details_about_clients_enquiry'
        db.delete_column(u'admission_enquiry', 'details_about_clients_enquiry')


        # Changing field 'Enquiry.remarks_for_follow_up_date'
        db.alter_column(u'admission_enquiry', 'remarks_for_follow_up_date', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Enquiry.remarks'
        db.alter_column(u'admission_enquiry', 'remarks', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    models = {
        u'admission.enquiry': {
