...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field batch on 'Student'
        db.create_table(u'admission_student_batch', (
        ...
        db.create_unique(u'admission_student_batch', ['student_id', 'batch_id'])

        # Adding field 'Enquiry.saved_date'
        db.add_column(u'admission_enquiry', 'saved_date',
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field batch on 'Student'
        db.delete_table('admission_student_batch')

        # Deleting field 'Enquiry.saved_date'
        db.delete_column(u'admission_enquiry', 'saved_date')
    ...
    models = {
        ...
        u'admission.student': {
            ...
            'batch': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['college.Batch']", 'null': 'True', 'blank': 'True'}),
