...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enquiry.is_admitted'
        db.add_column(u'admission_enquiry', 'is_admitted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Enquiry.is_admitted'
        db.delete_column(u'admission_enquiry', 'is_admitted')
