...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.enquiry'
        db.add_column(u'admission_student', 'enquiry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admission.Enquiry'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Student.enquiry'
        db.delete_column(u'admission_student', 'enquiry_id')
