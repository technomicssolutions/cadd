...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Permission.college_module'
        db.delete_column(u'staff_permission', 'college_module')

        # Deleting field 'Permission.admission_module'
        db.delete_column(u'staff_permission', 'admission_module')

        # Adding field 'Permission.student_module'
        db.add_column(u'staff_permission', 'student_module',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Permission.master_module'
        db.add_column(u'staff_permission', 'master_module',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Permission.college_module'
        db.add_column(u'staff_permission', 'college_module',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Permission.admission_module'
        db.add_column(u'staff_permission', 'admission_module',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Permission.student_module'
        db.delete_column(u'staff_permission', 'student_module')

        # Deleting field 'Permission.master_module'
        db.delete_column(u'staff_permission', 'master_module')
