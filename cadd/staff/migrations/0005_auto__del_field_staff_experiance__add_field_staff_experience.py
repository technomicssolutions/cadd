...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Staff.experiance'
        db.delete_column(u'staff_staff', 'experiance')

        # Adding field 'Staff.experience'
        db.add_column(u'staff_staff', 'experience',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Staff.experiance'
        db.add_column(u'staff_staff', 'experiance',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Staff.experience'
        db.delete_column(u'staff_staff', 'experience')
