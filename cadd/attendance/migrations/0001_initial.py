...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'attendance_attendance', (
            ...
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Staff'], null=True, blank=True)),
            ...
            ('presented', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'attendance.attendance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'presented': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
