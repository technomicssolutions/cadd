...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attendance.presented'
        db.add_column(u'attendance_attendance', 'presented',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Attendance.presented'
        db.delete_column(u'attendance_attendance', 'presented')
    ...
    models = {
        ...
        u'attendance.attendance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'presented': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            ...
            'teacher': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['staff.Staff']", 'null': 'True', 'blank': 'True'})
        },
