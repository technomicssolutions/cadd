...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'attendance_attendance', 'status')

        # Deleting field 'Attendance.student'
        db.delete_column(u'attendance_attendance', 'student_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'attendance_attendance', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Attendance.student'
        db.add_column(u'attendance_attendance', 'student',
