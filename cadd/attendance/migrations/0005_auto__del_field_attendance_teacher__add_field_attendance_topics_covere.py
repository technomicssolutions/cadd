...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Attendance.teacher'
        db.delete_column(u'attendance_attendance', 'teacher_id')

        # Adding field 'Attendance.topics_covered'
        db.add_column(u'attendance_attendance', 'topics_covered',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Attendance.remarks'
        db.add_column(u'attendance_attendance', 'remarks',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Attendance.teacher'
        db.add_column(u'attendance_attendance', 'teacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Staff'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Attendance.topics_covered'
        db.delete_column(u'attendance_attendance', 'topics_covered')

        # Deleting field 'Attendance.remarks'
        db.delete_column(u'attendance_attendance', 'remarks')
    ...
    models = {
        ...
        u'attendance.holidaycalendar': {
            'Meta': {'object_name': 'HolidayCalendar'},
            'date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
