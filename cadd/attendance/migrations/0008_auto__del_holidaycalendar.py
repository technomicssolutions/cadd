...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'HolidayCalendar'
        db.delete_table(u'attendance_holidaycalendar')

    def backwards(self, orm):
        # Adding model 'HolidayCalendar'
        db.create_table(u'attendance_holidaycalendar', (
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_holiday', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'attendance', ['HolidayCalendar'])
